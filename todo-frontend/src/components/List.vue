      ...
      <b-row>
        <b-col xs="12" sm="6" md="4" v-for="list in lists" :key="list.id">
          <div class="controls">
            ...
            <bbadge @click.prevent="deleteList(list)" href="#" variant="danger" pill>X</bbadge>
          </div>
          <b-card-group deck>
            <b-card class="mt-5 mx-1" bg-variant="light" nobody :header="list.title">
            ...
            <b-card class="mt-5 mx-1" no-body>
              <b-input-group prepend="New list">
                ...
                <b-input-group-append>
                  <bbutton @click="addList" size="sm" text="Add" variant="success">Add</bbutton>
                </b-input-group-append>
              </b-input-group>
            </b-card>
          </b-card-group>
